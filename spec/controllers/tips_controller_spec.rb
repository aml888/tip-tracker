...
describe TipsController do
  ...
  let(:valid_attributes) { { "news_tip" => "MyText" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved tip as @tip" do
        ...
        post :create, {:tip => { "news_tip" => "invalid value" }}, valid_session
        assigns(:tip).should be_a_new(Tip)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested tip" do
        ...
        Tip.any_instance.should_receive(:update).with({ "news_tip" => "MyText" })
        put :update, {:id => tip.to_param, :tip => { "news_tip" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the tip as @tip" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Tip.any_instance.stub(:save).and_return(false)
        put :update, {:id => tip.to_param, :tip => { "news_tip" => "invalid value" }}, valid_session
        assigns(:tip).should eq(tip)
      end
